    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 border-b">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
       <router-link to="/"><img src="./assets/logo.png" alt="" srcset=""> </router-link> 
        ...
        <SearchBukuVue class="hidden lg:block" />
...
<footer class="bg-neutral-100 dark:bg-gray-900 border-t">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src="./assets/logo.png" class="h-8 me-3" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Penerbit IKAPI</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Anggota IKAPI</a>
                      </li>
                      <li>
                          <a href="#" class="hover:underline">IKAPI</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 Penerbit IKAPI. All Rights Reserved.
          </span>
